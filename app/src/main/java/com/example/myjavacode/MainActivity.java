        ...
        btnCreate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                try {
                    ...
                    HttpUrl.Builder urlBuilder = HttpUrl.parse("http://192.168.8.16/danphp/crudapi/create.php").newBuilder();
...
//        READ CONTACTS FROM DATAASE SQLITE
        ...
        btnRead.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                try {
                    ...
                    HttpUrl.Builder urlBuilder = HttpUrl.parse("http://192.168.43.29/danphp/crudapi/read.php").newBuilder();
